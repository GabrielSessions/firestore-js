...
const firebaseConfig = {
  apiKey: "AIzaSyAdhvdGmYcivjLUypd1KYqyV2Ge5frl95g",
  authDomain: "service-firebase.firebaseapp.com",
  projectId: "service-firebase",
  storageBucket: "service-firebase.appspot.com",
  messagingSenderId: "968114333754",
  appId: "1:968114333754:web:c166ab2af02f5cba782d03",
  measurementId: "G-L9HBL34TYM"
};

const myDB = new ServiceFirestore(firebaseConfig, "users");

const docId = await myDB.createDocument({
    born: 2002,
    first: "Gabriel",
    last: "Sessions"
}, "users");

const unsub = myDB.listenToDocument(docId);

setTimeout(() => {
    unsub();
    myDB.deleteDocument(docId);
}, 10000);
*/
